...
To build, iterate the code version and release number in `fika-collect/fika-collect-app/android/app/build.gradle`

Then,navigate to `fika-collect/fika-collect-app/android` and run
