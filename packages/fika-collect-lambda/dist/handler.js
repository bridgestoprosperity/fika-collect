...
import { uploadPresignerRequestSchema, surveySubmissionRequestSchema, } from "./requestSchema.js";
...
async function presignUpload(event) {
    try {
        ...
        const uploadURL = await generatePresignedUrl(s3, requestParams.data);
        return responseSchema.parse({
            statusCode: 200,
