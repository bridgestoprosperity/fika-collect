...
The following is an _outdated_ list of AWS resources. Most of the IAM and S3 config still exists, but Lambdas are now obsolete, as is cloudformation managed deployment and the API gateway.
